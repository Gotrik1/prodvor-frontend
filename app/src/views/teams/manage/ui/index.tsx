...
import { teams, users, playgrounds } from "@/mocks";
import type { Team, User } from "@/mocks";
import { Button } from "@/shared/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/shared/ui/card";
import Link from "next/link";
import { CheckCircle, Crown, Mail, Shield, Trash2, UserPlus, Users, Home, Edit, XCircle } from "lucide-react";
        ...
        <div className="p-4 md:p-6 lg:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-8">
                    ...
                    <Card>
                        <CardHeader>
                           <CardTitle className="flex items-center gap-2"><Home />Домашняя площадка</CardTitle>
                        </CardHeader>
                        <CardContent>
                            {homePlayground ? (
                                <div className="space-y-3">
                                    <p className="font-semibold">{homePlayground.name}</p>
                                    <p className="text-xs text-muted-foreground">{homePlayground.address}</p>
                                    <Button variant="outline" size="sm" className="w-full"><Edit className="mr-2 h-3 w-3" />Сменить площадку</Button>
                                </div>
                            ) : (
                                <div className="space-y-3">
                                    <Label htmlFor="home-playground">Выберите площадку</Label>
                                    <Select>
                                        <SelectTrigger id="home-playground">
                                    ...
                                    <Button className="w-full">Назначить домашней</Button>
                                </div>
                            )}
                        </CardContent>
                    </Card>

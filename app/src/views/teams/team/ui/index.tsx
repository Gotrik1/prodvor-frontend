...
import { Crown, Swords, Trophy, UserPlus, Home } from "lucide-react";
            ...
            <div className="border rounded-lg p-4 md:p-6 space-y-6 bg-card">
                <header className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        {homePlayground && (
                             <Link href={`/playgrounds/${homePlayground.id}`} className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-1.5 mt-1 justify-center md:justify-start">

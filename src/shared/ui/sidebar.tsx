...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto custom-scrollbar p-2",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    className={cn("flex w-full min-w-0 flex-col md:gap-4 xl:gap-1", className)}
    {...props}
  />
))

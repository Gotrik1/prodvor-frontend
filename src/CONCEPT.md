...
- **Роли при регистрации:** Пользователь выбирает свою основную роль при регистрации (например, игрок, судья, организатор, болельщик, тренер).
- **Персональные страницы по ролям:** После регистрации для каждой роли формируется уникальная персональная страница (дэшборд) с соответствующим набором виджетов, инструментов и информации, необходимой для этой роли.

### 3.2. Команды

- **Создание и управление:** Игрок, создавший команду, автоматически становится ее капитаном. Его глобальная роль на платформе при этом остается "Игрок", но внутри команды он получает расширенные права (приглашение/исключение игроков, управление составом, подача заявок на турниры), и его статус капитана виден всем участникам команды.
- **Персональная страница команды:** У каждой команды есть своя уникальная страница с логотипом (генерируемым AI), статистикой, историей матчей и составом.
...
1.  **Регистрация:** Пользователь создает свой ProDvor ID и выбирает свою основную роль.

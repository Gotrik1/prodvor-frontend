...
import type { PlanType } from '@/views/fitness-plan/ui/types'; // Unused imports User and Users
...
const planTypes: PlanType[] = [
    ...
    { value: '5-day-split', label: 'Сплит на 5 дней', days: 5, description: 'Профессиональный сплит с отдельным днем для каждой крупной мышечной группы.' },

...
const basePlaygrounds: Omit<Playground, 'followers' | 'residentTeamIds'>[] = [
    ...
    { id: 'p6', name: 'Регбийный стадион "Слава"', address: 'г. Москва, ул. Селезнёвская, 13А', type: 'Стадион', surface: 'Газон', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'rugby stadium', sportIds: ['sport-6'] },
    ...
    { id: 'p19', name: 'Компьютерный клуб "Winstrike"', address: 'г. Москва, ул. Киберспортивная, 1', type: 'Закрытое помещение', surface: 'Паркет', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'gaming club', sportIds: ['sport-19'] },
    ...
    { id: 'p21', name: 'Универсальная школьная площадка', address: 'г. Москва, ул. Образцовая, 10', type: 'Открытая площадка', surface: 'Асфальт', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'school yard', sportIds: ['sport-21'] },
    ...
    { id: 'p24', name: 'Шахматный клуб им. Петросяна', address: 'г. Москва, ул. Большая Дмитровка, 11', type: 'Закрытое помещение', surface: 'Паркет', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'chess club', sportIds: ['sport-24', 'sport-49'] },
    // --- Некомандные виды спорта ---
    { id: 'p27', name: 'Теннисный корт "Чемпион"', address: 'г. Москва, ул. Спортивная, 10', type: 'Открытая площадка', surface: 'Грунт', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'tennis court', sportIds: ['sport-27'] },
    ...
    { id: 'p30', name: 'Зал единоборств "Будокан"', address: 'г. Новосибирск, ул. Самураев, 5', type: 'Закрытое помещение', surface: 'Татами', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'dojo interior', sportIds: ['sport-30'] },
    ...
    { id: 'p32', name: 'Стрелковый клуб "Объект"', address: 'г. Москва, МКАД, 16-й километр', type: 'Специализированный объект', surface: 'Синтетика', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'shooting range', sportIds: ['sport-32'] },
    ...
    { id: 'p36', name: 'Центр гимнастики Ирины Винер-Усмановой', address: 'г. Москва, ул. Лужники, 24, стр. 24', type: 'Спортивный центр', surface: 'Синтетика', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'gymnastics center', sportIds: ['sport-36'] },
    ...
    { id: 'p38', name: 'Скалодром "Скала Сити"', address: 'г. Москва, Кутузовский просп., 36', type: 'Закрытое помещение', surface: 'Синтетика', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'climbing gym', sportIds: ['sport-38'] },
    ...
    { id: 'p42', name: 'Велотрек "Крылатское"', address: 'г. Москва, ул. Крылатская, 10', type: 'Специализированный объект', surface: 'Дерево', imageUrl: 'https://placehold.co/400x300.png', dataAiHint: 'velodrome', sportIds: ['sport-42'] },

...
export const users: User[] = [
  ...
  { id: 'user84', firstName: 'Егор', lastName: 'Крид', nickname: 'Kreed', avatarUrl: 'https://i.pravatar.cc/150?u=user84', email: 'user84@example.com', role: 'Игрок', gender: 'мужской', age: 28, city: 'Махачкала', phone: '+7 (928) 333-44-55', friends: [], followers: [], followingUsers: [], followingTeams: [] },

...
const roles = [
  {
    ...
    slug: 'team',
    description:
      'Публичная страница команды с составом, матчами и статистикой.',
    icon: Users,
  },
  {
    name: 'Тренер',
  ...
  },
  {
    ...
    slug: 'referee',
    description:
      'Управление матчами, фиксация результатов и просмотр расписания.',
    icon: Gavel,
  },
  {
    name: 'Менеджер',
    slug: 'manager',
    description:
      'Инструменты для управления несколькими командами и игроками.',
    icon: Briefcase,
  },
  {
    name: 'Модератор',
  ...
  },
  {
    ...
    slug: 'fan',
    description:
      'Лента новостей, отслеживаемые команды и предстоящие матчи.',
    icon: Star,
  },
];

const TemplateCardLink = ({
  name,
  description,
  icon: Icon,
  slug,
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mt-4 max-w-3xl mx-auto">
              Этот раздел предназначен для управления платформой и просмотра
              шаблонов страниц для различных ролей и сущностей. Нажмите на
              карточку для предпросмотра.
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="cursor-pointer h-full hover:border-primary transition-colors hover:shadow-lg">
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground">
                          Страница с формой для создания нового турнира.
                        </p>
                      </CardContent>
                    </Card>
                  </Link>
                  ...
                  <Link href="/tournaments/mytourney1/manage">
                    <Card className="cursor-pointer h-full hover:border-primary transition-colors hover:shadow-lg">
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground">
                          Страница CRM для управления существующим турниром.
                        </p>
                      </CardContent>
                    </Card>
                  </Link>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <Link href="/admin/advertising">
                    <Card className="cursor-pointer h-full hover:border-primary transition-colors hover:shadow-lg">
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground">
                          Управление рекламой, аналитика и прогнозирование.
                        </p>
                      </CardContent>
                    </Card>
                  </Link>

...
export const MINIO_SETUP_GUIDE = `
# Руководство по настройке MinIO для ProDvor

Это руководство описывает, как поднять и настроить локальное S3-совместимое хранилище MinIO с помощью Docker, чтобы обеспечить работу новой системы загрузки файлов.

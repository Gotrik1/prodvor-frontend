...
const PrivacySettingRow = ({
  ...
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 rounded-lg border">
    ...
    <div className="mt-2 sm:mt-0 sm:w-48">{children}</div>
  </div>
);
...
export function PrivacyTab() {
  ...
  const handleSave = () => {
    // In real app, you would collect all select/switch states and send them to API
    // api.put('/api/v1/users/me/privacy', { privacy_settings: { ... } });
    toast({
    ...
    <Card>
      ...
      <CardContent className="space-y-8">
        <PrivacyCategory title="Мой профиль" icon={User}>
          <PrivacySettingRow
            label="Кто видит основную информацию"
            description="Имя, аватар, город и ELO-рейтинг."
          >
          ...
          <PrivacySettingRow
            label="Кто видит мои команды и дисциплины"
            description="Список команд, в которых вы состоите."
          >
            <Select defaultValue="all">
              <SelectTrigger>
                <SelectValue />
          ...
          <PrivacySettingRow
            label="Кого видно в списке друзей и подписок"
            description="Кто может видеть, на кого вы подписаны."
          >
            <Select defaultValue="all">
              <SelectTrigger>
                <SelectValue />
        ...
        <PrivacyCategory title="Публикации" icon={ImageIcon}>
          <PrivacySettingRow
            label="Кто видит мои фото и видео"
            description="Ваши публикации в профиле."
          >
            <Select defaultValue="all">
              <SelectTrigger>
                <SelectValue />
          ...
          <PrivacySettingRow
            label="Кто может отмечать меня"
            description="Разрешить другим отмечать вас на фото и видео."
          >
        ...
        <PrivacyCategory title="Связь со мной" icon={MessageSquare}>
          <PrivacySettingRow
            ...
            description="Ограничьте круг лиц, которые могут вам писать."
          >
            <Select defaultValue="all">
              <SelectTrigger>
                <SelectValue />
          ...
          <PrivacySettingRow
            label="Кто может приглашать меня в команды"
            description="Ограничьте приглашения от капитанов команд."
          >
            <Select defaultValue="all">
              <SelectTrigger>
                <SelectValue />
        ...
        <PrivacyCategory title="Прочее" icon={Globe}>
          <PrivacySettingRow
            label="Кому видна моя страница"
            description="Доступ к странице для гостей."
          >
            <Select defaultValue="all">
              <SelectTrigger>
                <SelectValue />

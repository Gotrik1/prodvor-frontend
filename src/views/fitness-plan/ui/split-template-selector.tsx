...
export const splitTemplates: Record<PlanType['value'], SplitTemplate[]> = {
    ...
    '3-day-split': [
        { name: 'Пример 1: Классический', days: ['Спина и трицепс', 'Грудь и бицепс', 'Ноги и плечи'] },
        { name: 'Пример 2: Тяни-Толкай-Ноги', days: ['Грудь, плечи и трицепс', 'Спина и бицепс', 'Ноги'] },
        { name: 'Пример 3: Фокус на руки', days: ['Грудь и спина', 'Плечи и руки', 'Ноги'] },
    ],
    '4-day-split': [
        {
     ...
     '5-day-split': [
        { name: 'Классический "Бро-сплит"', days: ['Руки', 'Ноги', 'Плечи', 'Спина', 'Грудь'] },
    ],
    '2-through-2': [
        { name: 'Пример 1: Верх / Низ (x2)', days: ['Верх тела 1', 'Низ тела 1', 'Верх тела 2', 'Низ тела 2'] },
        { name: 'Пример 2: Продвинутый', days: ['Грудь, передняя и средняя дельта', 'Спина и задняя дельта', 'Ноги', 'Руки'] },
    ]
};

...
export const splitTemplates: Record<PlanType['value'], SplitTemplate[]> = {
    ...
    '3-day-split': [
        { name: 'Пример 1', days: ['Спина и трицепс', 'Грудь и бицепс', 'Ноги и плечи'] },
        { name: 'Пример 2', days: ['Грудь и Спина', 'Плечи, бицепс и трицепс', 'Ноги'] },
        { name: 'Пример 3', days: ['Грудь и плечи', 'Ноги и трицепс', 'Спина и бицепс'] },
        { name: 'Пример 4', days: ['Спина и грудь', 'Плечи и руки', 'Ноги'] },
    ],
    '4-day-split': [
        {

    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-8">
        ...
        <Tabs defaultValue="tournaments" className="w-full">
            <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="leagues"><BarChart className="mr-2 h-4 w-4" />Лиги</TabsTrigger>
                <TabsTrigger value="challenges"><Swords className="mr-2 h-4 w-4" />Вызовы</TabsTrigger>
            </TabsList>

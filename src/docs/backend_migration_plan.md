...
## Шаг 4: API для статистики команды
...
## Шаг 5: Создание API для Турниров (Tournaments)
...
## Шаг 6: Создание API для Постов и Комментариев
...
## Шаг 7: Создание API для остальных сущностей
...
## Шаг 8: Обновление данных пользователя (включая дисциплины)
